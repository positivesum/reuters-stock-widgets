<?php
if (!class_exists('cfct_module_stockchart')) {
	class cfct_module_stockchart extends cfct_build_module {
		/**
		 * Set up the module
		 */
		...
		public function __construct() {
			...
			$opts = array(
				'url' => $this->pluginUrl, 
				'view' => 'reuters-stock-widgets/stockchart-view.php',				
				'description' => __('Provides ability to generate Stock Chart for a specific stock.', 'carrington-build'),
				'icon' => 'reuters-stock-widgets/stockchart-icon.png'
			);
			...
			parent::__construct('cfct-stockchart', __('Stock Chart', 'carrington-build'), $opts);
		}
	...
	cfct_build_register_module('cfct-module-stockchart', 'cfct_module_stockchart');
}
