<?php
if (!class_exists('cfct_module_stockquote')) {
	class cfct_module_stockquote extends cfct_build_module {
		/**
		 * Set up the module
		 */
		...
		public function __construct() {
			...
			$opts = array(
				'url' => $this->pluginUrl, 
				'view' => 'reuters-stock-widgets/stockquote-view.php',				
				'description' => __('Provides stock quotes for a specific stock.', 'carrington-build'),
				'icon' => 'reuters-stock-widgets/stockquote-icon.png'
			);
			...
			parent::__construct('cfct-stockquote', __('Stock Quote', 'carrington-build'), $opts);
		}
	...
	cfct_build_register_module('cfct-module-stockquote', 'cfct_module_stockquote');
}
