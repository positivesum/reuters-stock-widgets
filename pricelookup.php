<?php
if (!class_exists('cfct_module_pricelookup')) {
	class cfct_module_pricelookup extends cfct_build_module {
		/**
		 * Set up the module
		 */
		...
		public function __construct() {
			...
			$opts = array(
				'url' => $this->pluginUrl, 
				'view' => 'reuters-stock-widgets/pricelookup-view.php',				
				'description' => __('Provides information about the stock on a particular day.', 'carrington-build'),
				'icon' => 'reuters-stock-widgets/pricelookup-icon.png'
			);
			...
			parent::__construct('cfct-pricelookup', __('Historical Price Lookup', 'carrington-build'), $opts);
		}
	...
	cfct_build_register_module('cfct-module-pricelookup', 'cfct_module_pricelookup');
}
