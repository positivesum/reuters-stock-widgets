<?php
if (!class_exists('cfct_module_ticker')) {
	class cfct_module_ticker extends cfct_build_module {
		/**
		 * Set up the module
		 */
		...
		public function __construct() {
			...
			$opts = array(
				'url' => $this->pluginUrl, 
				'view' => 'reuters-stock-widgets/ticker-view.php',				
				'description' => __('Provides ticker for a specific stock.', 'carrington-build'),
				'icon' => 'reuters-stock-widgets/ticker-icon.png'
			);
			...
			parent::__construct('cfct-ticker', __('Stock Ticker', 'carrington-build'), $opts);
		}
	...
	cfct_build_register_module('cfct-module-ticker', 'cfct_module_ticker');
}
